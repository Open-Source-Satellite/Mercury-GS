...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_25 = QtWidgets.QLabel(self.groupBox_91)
        self.label_25.setObjectName("label_25")
        self.horizontalLayout_8.addWidget(self.label_25)
        self.lineEditTcTlmTimeOut = QtWidgets.QLineEdit(self.groupBox_91)
        ...
        self.label_24 = QtWidgets.QLabel(self.groupBox_91)
        self.label_24.setObjectName("label_24")
        self.formLayout_3.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.label_24)
        self.horizontalLayout_9 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_9.setObjectName("horizontalLayout_9")
        self.lineEditConfigFilePath = QtWidgets.QLineEdit(self.groupBox_91)
        ...
        self.pushButtonOpenConfigFilePath = QtWidgets.QPushButton(self.groupBox_91)
        ...
        self.gridLayout_9.addWidget(self.groupBox_91, 0, 1, 1, 1)
        ...
        self.labelNewFrameDelimiter = QtWidgets.QLabel(self.groupBox_11)
        self.labelNewFrameDelimiter.setObjectName("labelNewFrameDelimiter")
        self.formLayout_7.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.labelNewFrameDelimiter)
        self.lineEditNewFrameDelimiter = QtWidgets.QLineEdit(self.groupBox_11)
        self.lineEditNewFrameDelimiter.setMinimumSize(QtCore.QSize(40, 0))
        self.lineEditNewFrameDelimiter.setMaximumSize(QtCore.QSize(40, 16777215))
        self.lineEditNewFrameDelimiter.setObjectName("lineEditNewFrameDelimiter")
        self.formLayout_7.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.lineEditNewFrameDelimiter)
        self.labelReservedBytes = QtWidgets.QLabel(self.groupBox_11)
        self.labelReservedBytes.setObjectName("labelReservedBytes")
        self.formLayout_7.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.labelReservedBytes)
        self.horizontalLayout_22 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_22.setObjectName("horizontalLayout_22")
        self.lineEditReservedBytesA = QtWidgets.QLineEdit(self.groupBox_11)
        self.lineEditReservedBytesA.setMinimumSize(QtCore.QSize(40, 0))
        self.lineEditReservedBytesA.setMaximumSize(QtCore.QSize(40, 16777215))
        self.lineEditReservedBytesA.setObjectName("lineEditReservedBytesA")
        self.horizontalLayout_22.addWidget(self.lineEditReservedBytesA)
        self.lineEditReservedBytesB = QtWidgets.QLineEdit(self.groupBox_11)
        self.lineEditReservedBytesB.setMinimumSize(QtCore.QSize(40, 0))
        self.lineEditReservedBytesB.setMaximumSize(QtCore.QSize(40, 16777215))
        self.lineEditReservedBytesB.setObjectName("lineEditReservedBytesB")
        self.horizontalLayout_22.addWidget(self.lineEditReservedBytesB)
        self.lineEditReservedBytesC = QtWidgets.QLineEdit(self.groupBox_11)
        self.lineEditReservedBytesC.setMinimumSize(QtCore.QSize(40, 0))
        self.lineEditReservedBytesC.setMaximumSize(QtCore.QSize(40, 16777215))
        self.lineEditReservedBytesC.setObjectName("lineEditReservedBytesC")
        self.horizontalLayout_22.addWidget(self.lineEditReservedBytesC)
        ...
        self.labelDataType = QtWidgets.QLabel(self.groupBox_11)
        self.labelDataType.setObjectName("labelDataType")
        self.formLayout_7.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.labelDataType)
        self.lineEditDataType = QtWidgets.QLineEdit(self.groupBox_11)
        self.lineEditDataType.setMinimumSize(QtCore.QSize(40, 0))
        self.lineEditDataType.setMaximumSize(QtCore.QSize(40, 16777215))
        self.lineEditDataType.setObjectName("lineEditDataType")
        self.formLayout_7.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.lineEditDataType)
        self.labelDataLength = QtWidgets.QLabel(self.groupBox_11)
        self.labelDataLength.setObjectName("labelDataLength")
        self.formLayout_7.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.labelDataLength)
        self.horizontalLayout_23 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_23.setObjectName("horizontalLayout_23")
        self.lineEditDataLength = QtWidgets.QLineEdit(self.groupBox_11)
        self.lineEditDataLength.setMinimumSize(QtCore.QSize(40, 0))
        self.lineEditDataLength.setMaximumSize(QtCore.QSize(40, 16777215))
        self.lineEditDataLength.setObjectName("lineEditDataLength")
        self.horizontalLayout_23.addWidget(self.lineEditDataLength)
        spacerItem6 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_23.addItem(spacerItem6)
        self.pushButtonTransmit = QtWidgets.QPushButton(self.groupBox_11)
        self.pushButtonTransmit.setObjectName("pushButtonTransmit")
        self.horizontalLayout_23.addWidget(self.pushButtonTransmit)
        self.formLayout_7.setLayout(3, QtWidgets.QFormLayout.FieldRole, self.horizontalLayout_23)
        self.labelDataField = QtWidgets.QLabel(self.groupBox_11)
        self.labelDataField.setObjectName("labelDataField")
        self.formLayout_7.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.labelDataField)
        self.plainTextEditDataField = QtWidgets.QPlainTextEdit(self.groupBox_11)
        self.plainTextEditDataField.setObjectName("plainTextEditDataField")
        self.formLayout_7.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.plainTextEditDataField)
        ...
        self.plainTextEditResponse = QtWidgets.QPlainTextEdit(self.groupBox_11)
        self.plainTextEditResponse.setObjectName("plainTextEditResponse")
        self.formLayout_7.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.plainTextEditResponse)
    ...
    def retranslateUi(self, Form):
        ...
        self.groupBox_91.setTitle(_translate("Form", "Config"))
        ...
        self.labelNewFrameDelimiter.setText(_translate("Form", "New Frame Delimiter"))
        ...
        self.pushButtonTransmit.setText(_translate("Form", "Transmit"))
