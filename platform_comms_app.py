...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(-1, 19, 601, 171))
        self.gridLayoutWidget_2.setObjectName("gridLayoutWidget_2")
        self.gridLayout_4 = QtWidgets.QGridLayout(self.gridLayoutWidget_2)
        self.gridLayout_4.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_4.setObjectName("gridLayout_4")
        self.lineEditUploadFrom = QtWidgets.QLineEdit(self.gridLayoutWidget_2)
        self.lineEditUploadFrom.setObjectName("lineEditUploadFrom")
        self.gridLayout_4.addWidget(self.lineEditUploadFrom, 1, 1, 1, 1)
        self.labelUploadTo = QtWidgets.QLabel(self.gridLayoutWidget_2)
        self.labelUploadTo.setObjectName("labelUploadTo")
        self.gridLayout_4.addWidget(self.labelUploadTo, 0, 0, 1, 1)
        self.lineEditUploadTo = QtWidgets.QLineEdit(self.gridLayoutWidget_2)
        self.lineEditUploadTo.setObjectName("lineEditUploadTo")
        self.gridLayout_4.addWidget(self.lineEditUploadTo, 0, 1, 1, 2)
        self.pushButtonOpenFileUploadFrom = QtWidgets.QPushButton(self.gridLayoutWidget_2)
        self.pushButtonOpenFileUploadFrom.setObjectName("pushButtonOpenFileUploadFrom")
        self.gridLayout_4.addWidget(self.pushButtonOpenFileUploadFrom, 1, 2, 1, 1)
        self.labelUploadFrom = QtWidgets.QLabel(self.gridLayoutWidget_2)
        self.labelUploadFrom.setObjectName("labelUploadFrom")
        self.gridLayout_4.addWidget(self.labelUploadFrom, 1, 0, 1, 1)
        self.gridLayout_7 = QtWidgets.QGridLayout()
        self.gridLayout_7.setObjectName("gridLayout_7")
        spacerItem1 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_7.addItem(spacerItem1, 0, 2, 1, 1)
        self.progressBarUpload = QtWidgets.QProgressBar(self.gridLayoutWidget_2)
        self.progressBarUpload.setProperty("value", 24)
        self.progressBarUpload.setObjectName("progressBarUpload")
        self.gridLayout_7.addWidget(self.progressBarUpload, 1, 0, 1, 3)
        self.pushButtonAbortUploadFile = QtWidgets.QPushButton(self.gridLayoutWidget_2)
        self.pushButtonAbortUploadFile.setObjectName("pushButtonAbortUploadFile")
        self.gridLayout_7.addWidget(self.pushButtonAbortUploadFile, 0, 1, 1, 1)
        self.pushButtonUploadFile = QtWidgets.QPushButton(self.gridLayoutWidget_2)
        self.pushButtonUploadFile.setObjectName("pushButtonUploadFile")
        self.gridLayout_7.addWidget(self.pushButtonUploadFile, 0, 0, 1, 1)
        self.gridLayout_4.addLayout(self.gridLayout_7, 2, 0, 1, 3)
        self.groupBox_8 = QtWidgets.QGroupBox(self.groupBox_5)
        self.groupBox_8.setGeometry(QtCore.QRect(0, 190, 600, 189))
        self.groupBox_8.setObjectName("groupBox_8")
        self.gridLayoutWidget_4 = QtWidgets.QWidget(self.groupBox_8)
        self.gridLayoutWidget_4.setGeometry(QtCore.QRect(-1, 19, 601, 171))
        self.gridLayoutWidget_4.setObjectName("gridLayoutWidget_4")
        self.gridLayout_8 = QtWidgets.QGridLayout(self.gridLayoutWidget_4)
        self.gridLayout_8.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_8.setObjectName("gridLayout_8")
        self.lineEditDownloadTo = QtWidgets.QLineEdit(self.gridLayoutWidget_4)
        self.lineEditDownloadTo.setObjectName("lineEditDownloadTo")
        self.gridLayout_8.addWidget(self.lineEditDownloadTo, 1, 1, 1, 1)
        self.labelDownloadFrom = QtWidgets.QLabel(self.gridLayoutWidget_4)
        self.labelDownloadFrom.setObjectName("labelDownloadFrom")
        self.gridLayout_8.addWidget(self.labelDownloadFrom, 0, 0, 1, 1)
        self.lineEditDownloadFrom = QtWidgets.QLineEdit(self.gridLayoutWidget_4)
        self.lineEditDownloadFrom.setObjectName("lineEditDownloadFrom")
        self.gridLayout_8.addWidget(self.lineEditDownloadFrom, 0, 1, 1, 2)
        self.pushButtonOpenFileDownloadTo = QtWidgets.QPushButton(self.gridLayoutWidget_4)
        self.pushButtonOpenFileDownloadTo.setObjectName("pushButtonOpenFileDownloadTo")
        self.gridLayout_8.addWidget(self.pushButtonOpenFileDownloadTo, 1, 2, 1, 1)
        self.labelDownloadTo = QtWidgets.QLabel(self.gridLayoutWidget_4)
        self.labelDownloadTo.setObjectName("labelDownloadTo")
        self.gridLayout_8.addWidget(self.labelDownloadTo, 1, 0, 1, 1)
        self.gridLayout_10 = QtWidgets.QGridLayout()
        self.gridLayout_10.setObjectName("gridLayout_10")
        spacerItem2 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_10.addItem(spacerItem2, 0, 1, 1, 1)
        self.pushButtonRequestDownload = QtWidgets.QPushButton(self.gridLayoutWidget_4)
        self.pushButtonRequestDownload.setObjectName("pushButtonRequestDownload")
        self.gridLayout_10.addWidget(self.pushButtonRequestDownload, 0, 0, 1, 1)
        self.progressBarDownload = QtWidgets.QProgressBar(self.gridLayoutWidget_4)
        self.progressBarDownload.setProperty("value", 24)
        self.progressBarDownload.setObjectName("progressBarDownload")
        self.gridLayout_10.addWidget(self.progressBarDownload, 1, 0, 1, 2)
        self.gridLayout_8.addLayout(self.gridLayout_10, 2, 0, 1, 3)
        ...
        self.groupBox_7.setGeometry(QtCore.QRect(0, 0, 641, 401))
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButtonOpenFileUploadFrom.setText(_translate("Form", "Open"))
        ...
        self.groupBox_8.setTitle(_translate("Form", "To Download"))
        self.labelDownloadFrom.setText(_translate("Form", "Download from:"))
        self.pushButtonOpenFileDownloadTo.setText(_translate("Form", "Open"))
        ...
        self.groupBox_7.setTitle(_translate("Form", "Config"))
