...
###################################################################################
from api.resources.low_level.serial_comms import frame_queue, serial_send
from api.resources.low_level.frameformat import MessageFormat, DataType, struct, PROTOCOL_DELIMITER
from api.resources.low_level.continuous import continuous_sender, register_continuous
import config
import threading
...
def packetize(data_to_packet, data_type, is_continuous: bool, message_object_database, latest_message_object):
