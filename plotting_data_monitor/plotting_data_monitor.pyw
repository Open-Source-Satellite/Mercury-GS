 ...
 *  Modified version for Python3, PyQt5 and to use QProgressBar instead of qwtthermo.    
...
from PyQt5.QtWidgets import QMainWindow, QApplication, QAction, QLabel, QLineEdit,\
    QHBoxLayout, QGroupBox, QVBoxLayout, QWidget, QProgressBar, QDial, QMessageBox, QInputDialog
...
# looks like qwtthermo has not been ported to python
# use QProgressBar instead
...
#        return thermo
    ...
    def create_knob(self):
        # QwtKnob not available, try QDial
    ...
    def create_main_frame(self):
        ...
        thermo_layout.addWidget(self.bar)
        ...
        #    self.on_knob_change)
        self.updatespeed_knob.valueChanged.connect(self.on_knob_change)
    ...
    def on_start(self):
        ...
        if update_freq > 0:
            ...
            self.timer.start(int(1000.0 / update_freq))
    ...
    def update_monitor(self):
        ...
        if self.livefeed.has_new_data:
            ...
            self.bar.setValue(int(avg))
            
            #self.timer.setInterval(1000.0 / update_freq)
            self.timer.setInterval(int(1000.0 / update_freq))
